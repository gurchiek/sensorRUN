function [ session ] = rbmxInitializeProject_sensorRUNio(session)
%Reed Gurchiek, 2020
%   analyze apdm imu data during running activity using r/l shank and
%   pelvis data from an indoor trial and an outdoor trial
%
...
%
%--------------------------------------------------------------------------
%% rbmxInitializeProject_sensorRUNio

% activity ID
activityIdentification.name = 'sensorRUN_ioID';
activityIdentification.function = str2func('rbmxActivityIdentification_sensorRUN_ioID');
